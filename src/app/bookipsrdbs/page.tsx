            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="lg:w-3/4">
                ...
                <div className="space-y-8 mb-8">
                  ...
                  <div className="mt-8">
                    <h2 className="text-2xl font-semibold text-gray-900 mb-4">Chapter Summaries</h2>
                    <ul className="space-y-4">
                      <li>
                        ...
                        <p className="text-gray-700">
                          This introductory chapter provides an overview of basic statistical concepts and their importance in data science.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="text-gray-700">
                          Chapter 2 introduces R programming language and its basic operations. Many examples are provided to illustrate the concepts.
                        </p>
                      </li>
                    </ul>
                  </div>
